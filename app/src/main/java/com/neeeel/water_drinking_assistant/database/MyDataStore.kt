...
import com.neeeel.water_drinking_assistant.App
...
object MyDataStore {
    ...
    private val DATA_STORE_NAME = App.INSTANCE.packageName

    // 创建 DataStore
    private val App.dataStore: DataStore<Preferences> by preferencesDataStore(name = DATA_STORE_NAME)
    // DataStore 变量
